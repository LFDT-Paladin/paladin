...
export const RpcMethods = {
  ...
  pgroup_sendMessage: 'pgroup_sendMessage',
  pgroup_createGroup: 'pgroup_createGroup',
  pgroup_queryMessageListeners: 'pgroup_queryMessageListeners',
  ...
  ptx_call: 'ptx_call',
  ptx_createBlockchainEventListener: 'ptx_createBlockchainEventListener',
  ptx_createReceiptListener: 'ptx_createReceiptListener',
  ptx_decodeCall: 'ptx_decodeCall',
  ptx_decodeEvent: 'ptx_decodeEvent',
  ptx_deleteBlockchainEventListener: 'ptx_deleteBlockchainEventListener',
  ...
  ptx_queryBlockchainEventListeners: 'ptx_queryBlockchainEventListeners',
  ptx_queryReceiptListeners: 'ptx_queryReceiptListeners',
  ...
  ptx_startBlockchainEventListener: 'ptx_startBlockchainEventListener',
  ptx_startReceiptListener: 'ptx_startReceiptListener',
  ptx_stopBlockchainEventListener: 'ptx_stopBlockchainEventListener',
  ptx_stopReceiptListener: 'ptx_stopReceiptListener',
