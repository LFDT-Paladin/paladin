...
func TestComputeLockIdBadTransactionID(t *testing.T) {
	...
	assertInternalAssemble(t, err, "FF22047|PD020007|bad|invalid")
	assertRevertEndorse(t, err, "FF22047|PD020007|bad|invalid")
}
...
func TestEncodeTransactionDataV0BadInfoStateID(t *testing.T) {
	...
	assertInternalAssemble(t, err, "PD020008|bad|invalid")
	assertRevertEndorse(t, err, "PD020008|bad|invalid")
}
...
func TestValidateTransactionCommonBadFunctionABI(t *testing.T) {
	...
	assertInternalAssemble(t, err, "unexpected end of JSON input")
...
func TestValidateTransactionCommonUnknownFunction(t *testing.T) {
	...
	_, _, err := validateTransactionCommon(t.Context(), spec, (&Noto{}).GetHandler)
	assertRevertAssemble(t, err, "PD200001.*notAFunction")
	assertRevertEndorse(t, err, "PD200001.*notAFunction")
}
...
func TestValidateTransactionCommonWrongSignature(t *testing.T) {
	...
	_, _, err := validateTransactionCommon(t.Context(), spec, (&Noto{}).GetHandler)
	assertRevertAssemble(t, err, "PD200002.*transfer")
	assertRevertEndorse(t, err, "PD200002.*transfer")
}
