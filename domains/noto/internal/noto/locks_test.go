...
func TestLoadLockInfoBadData(t *testing.T) {
	...
	assertInternalAssemble(t, err, "PD200053")
	assertInternalEndorse(t, err, "PD200053")
}
...
func TestLoadLockInfoNotFound(t *testing.T) {
	...
	_, err := n.loadLockInfoV1(ctx, "query-context", lockID)
	assertRevertAssemble(t, err, "PD200028")
	assertRevertEndorse(t, err, "PD200028")
}
...
func TestDecodeV1LockTransitionInvalidInputLock(t *testing.T) {
	...
	assertRevertAssemble(t, err, "PD200040")
	assertRevertEndorse(t, err, "PD200040")
}
...
func TestMissingLockCreate(t *testing.T) {
	...
	assertRevertAssemble(t, err, "PD200041")
	assertRevertEndorse(t, err, "PD200041")
}
...
func TestDecodeV1LockTransitionBadLockID(t *testing.T) {
	...
	assertRevertAssemble(t, err, "PD200039")
	assertRevertEndorse(t, err, "PD200039")
}
...
func TestDecodeV1LockTransitionWrongInputLockOwner(t *testing.T) {
	...
	assertRevertAssemble(t, err, "PD200018")
	assertRevertEndorse(t, err, "PD200018")
}
