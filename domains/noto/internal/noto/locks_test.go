...
func TestLoadLockInfoBadData(t *testing.T) {
	...
	assertAssembleInternal(t, err, "PD200040")
}
...
func TestLoadLockInfoNotFound(t *testing.T) {
	...
	_, err := n.loadLockInfoV1(ctx, "query-context", lockID)
	assertAssembleRevert(t, err, "PD200028")
}
...
func TestLoadLockInfoLoadFail(t *testing.T) {
	...
	_, err := n.loadLockInfoV1(ctx, "query-context", lockID)
	assertAssembleInternal(t, err, "pop")
}

func newValidV1LockTransition(t *testing.T, transitionType lockTransitionType, mods ...func(sender *identityPair, in *types.NotoLockInfo_V1, out *types.NotoLockInfo_V1)) (*lockTransition, EndorseError) {
	mockCallbacks := newMockCallbacks()
	n := &Noto{
		Callbacks:        mockCallbacks,
...
func TestDecodeV1LockTransitionInvalidInputLock(t *testing.T) {
	...
	assertEndorseRevert(t, err, "PD200040")
}
...
func TestMissingLockCreate(t *testing.T) {
	...
	assertEndorseRevert(t, err, "PD200041")
}
...
func TestDecodeV1LockTransitionBadLockID(t *testing.T) {
	...
	assertEndorseRevert(t, err, "PD200039")
}
...
func TestDecodeV1LockTransitionWrongInputLockOwner(t *testing.T) {
	...
	assertEndorseRevert(t, err, "PD200018")
}
