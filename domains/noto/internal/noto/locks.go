...
func (n *Noto) loadLockInfoV1(ctx context.Context, stateQueryContext string, lockID pldtypes.Bytes32) (info *loadedLockInfo, err error) {
	...
	if err != nil {
		return nil, i18n.WrapError(ctx, err, msgs.MsgInvalidStoredLockState, lockState.Id)
	}
