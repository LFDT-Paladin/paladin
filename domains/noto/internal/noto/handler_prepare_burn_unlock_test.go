...
func TestPrepareBurnUnlockCheckAllowedForFromLocalNodeNameFailed(t *testing.T) {
	...
	assertInternalAssemble(t, h.checkAllowedForFrom(t.Context(), tx, "sender"), "pop")
	assertInternalEndorse(t, h.checkAllowedForFrom(t.Context(), tx, "sender"), "pop")
}
...
func TestPrepareBurnUnlockCheckAllowedRevertsWhenBurnDisabled(t *testing.T) {
	...
	assertRevertAssemble(t, h.checkAllowed(t.Context(), tx), "PD200025")
	assertRevertEndorse(t, h.checkAllowed(t.Context(), tx), "PD200025")
}
...
func TestPrepareBurnUnlockCheckAllowedForFromUnparsableLocator(t *testing.T) {
	...
	assertRevertAssemble(t, h.checkAllowedForFrom(t.Context(), tx, "sender@node1@node2"), "PD020006")
	assertRevertEndorse(t, h.checkAllowedForFrom(t.Context(), tx, "sender@node1@node2"), "PD020006")
}
...
func TestPrepareBurnUnlockCheckAllowedForFromNotTheLockCreator(t *testing.T) {
	...
	assertRevertAssemble(t, h.checkAllowedForFrom(t.Context(), tx, "sender"), "PD200031")
	assertRevertEndorse(t, h.checkAllowedForFrom(t.Context(), tx, "sender"), "PD200031")
}
...
func TestPrepareBurnUnlockEndorseRevertsWhenLockedCoinsDoNotMatchTheBurnAmount(t *testing.T) {
	...
	assertRevertAssemble(t, err, "PD200013.*prepareBurnUnlock")
	assertRevertEndorse(t, err, "PD200013.*prepareBurnUnlock")
}

func TestPrepareBurnUnlockAssembleRevertsWhenTheLockHoldsMoreThanTheBurnAmount(t *testing.T) {
