...
func TestValidateMintAmountsRevertsOnInputs(t *testing.T) {
	...
	assertEndorseRevert(t, err, "PD200012.*mint")
}
...
func TestValidateMintAmountsRevertsOnMismatch(t *testing.T) {
	...
	assertEndorseRevert(t, err, "PD200013.*mint")
}
...
func TestValidateTransferAmountsRevertsOnNoInputs(t *testing.T) {
	...
	assertEndorseRevert(t, err, "PD200012.*transfer")
}
...
func TestValidateTransferAmountsRevertsOnMismatch(t *testing.T) {
	...
	assertEndorseRevert(t, err, "PD200013.*transfer")
}
...
func TestValidateBurnAmountsRevertsOnNoInputs(t *testing.T) {
	...
	assertEndorseRevert(t, err, "PD200012.*burn")
}
...
func TestValidateBurnAmountsRevertsOnMismatch(t *testing.T) {
	...
	assertEndorseRevert(t, err, "PD200013.*burn")
}
...
func TestValidateLockAmountsRevertsOnNoInputsInV0(t *testing.T) {
	...
	assertEndorseRevert(t, err, "PD200012.*lock")
}
...
func TestValidateLockAmountsRevertsOnMismatch(t *testing.T) {
	...
	assertEndorseRevert(t, err, "PD200013.*lock")
}
...
func TestValidateUnlockAmountsRevertsOnNoLockedInputsInV0(t *testing.T) {
	...
	assertEndorseRevert(t, err, "PD200012.*unlock")
}
...
func TestValidateUnlockAmountsRevertsOnMismatch(t *testing.T) {
	...
	assertEndorseRevert(t, err, "PD200013.*unlock")
}
...
func TestValidateOwnersRevertsOnWrongOwner(t *testing.T) {
	...
	assertEndorseRevert(t, n.validateOwners(t.Context(), "sender@node1", resolved, inputs.coins, inputs.states), "PD200018")

	locked := testLockedCoins(owner, 100)
	assertEndorseRevert(t, n.validateLockOwners(t.Context(), "sender@node1", resolved, locked.lockedCoins, locked.lockedStates), "PD200018")
}
...
func TestValidateSignatureRevertsWhenAbsent(t *testing.T) {
	assertEndorseRevert(t, (&Noto{}).validateSignature(t.Context(), "sender", nil, []byte("the encoded transfer")), "PD200015.*'sender'")
}
...
func TestValidateSignatureRevertsWhenItWillNotRecover(t *testing.T) {
	...
	assertEndorseRevert(t, (&Noto{}).validateSignature(t.Context(), "sender", attestations, message), "FF22087")
}
...
func TestValidateSignatureRevertsWhenItRecoversToSomeoneElse(t *testing.T) {
	...
	assertEndorseRevert(t, (&Noto{}).validateSignature(t.Context(), "sender", attestations, message), "PD200017.*'sender'")
}
