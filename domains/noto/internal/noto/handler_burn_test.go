...
func TestBurn(t *testing.T) {
	...
	require.NoError(t, err)
	expectedFunctionABI := hooksBuild.ABI.Functions()["onBurn"]
...
func TestBurnCheckAllowedRevertsWhenDisabled(t *testing.T) {
	...
	assertRevertAssemble(t, h.checkBurnAllowed(t.Context(), tx), "PD200025")
	assertRevertEndorse(t, h.checkBurnAllowed(t.Context(), tx), "PD200025")
}
