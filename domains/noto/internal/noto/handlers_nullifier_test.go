...
func TestValidateDistinctNullifiers(t *testing.T) {
	...
	assertRevertAssemble(t, err, "PD200045")
	assertRevertEndorse(t, err, "PD200045")
	...
	assertRevertAssemble(t, err, "PD200044")
	assertRevertEndorse(t, err, "PD200044")
	...
	assertRevertAssemble(t, err, "PD200006")
	assertRevertEndorse(t, err, "PD200006")
...
func TestValidateNullifierSpecs(t *testing.T) {
	...
	assertInternalAssemble(t, err, "PD200046")
	assertInternalEndorse(t, err, "PD200046")
	...
	assertInternalAssemble(t, err, "PD200048")
	assertInternalEndorse(t, err, "PD200048")
