...
func TestValidateDistinctNullifiers(t *testing.T) {
	...
	assertEndorseRevert(t, err, "PD200045")
	...
	assertEndorseRevert(t, err, "PD200044")
	...
	assertEndorseRevert(t, err, "PD200006")
...
func TestValidateNullifierSpecs(t *testing.T) {
	...
	assertAssembleInternal(t, err, "PD200046")
	...
	assertAssembleInternal(t, err, "PD200048")
