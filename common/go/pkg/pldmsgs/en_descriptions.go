...
var (
	...
	SequencerConfigDispatchCommitRetry               = pdm("SequencerConfig.dispatchCommitRetry", "Retry behavior for committing a dispatch batch to the database; retries indefinitely on failure")
	...
	SequencerConfigPrepareRetry                      = pdm("SequencerConfig.prepareRetry", "Retry behavior for preparing a transaction and building its dispatch; once the attempts are exhausted the transaction is returned to the pool")
