...
var (
	...
	DispatchID                                              = pdm("Dispatch.id", "Unique identifier for the dispatch record")
	DispatchPrivateTransactionID                            = pdm("Dispatch.privateTransactionID", "The private transaction that triggered this dispatch")
	DispatchPublicTransactionAddress                        = pdm("Dispatch.publicTransactionAddress", "The signing address of the public transaction created for this dispatch")
	...
	ChainedTransactionChainedTransactionID                  = pdm("ChainedTransaction.chainedTransactionID", "The transaction ID of the chained private transaction")
	ChainedTransactionTransactionID                         = pdm("ChainedTransaction.transactionID", "The original transaction that triggered this chained transaction")
	ChainedTransactionLocalID                               = pdm("ChainedTransaction.localID", "Local identifier for the chaining record, correlates with sequencer activity subjectId for chained dispatches")
