...
func GenerateAPIObjectsReferenceMarkdown(ctx context.Context) (map[string][]byte, error) {
...
func (d *apiDocGenerator) generateMarkdownPages(ctx context.Context, types, simpleTypes []interface{}, apiTypes []pldclient.RPCModule, outputPath string) (map[string][]byte, error) {
...
func (d *apiDocGenerator) generateMethodTypesMarkdown(ctx context.Context, apiGroup pldclient.RPCModule, outputPath string) ([]byte, error) {
...
func (d *apiDocGenerator) generateMethodReferenceMarkdown(ctx context.Context, method methodDescription, outputPath string) ([]byte, error) {
...
func (d *apiDocGenerator) getParamField(p param) string {
	listMarker := ""
	if p.isList {
		listMarker = "[]"
	}
...
func (d *apiDocGenerator) generateMethodDescriptions(apiGroup pldclient.RPCModule, reflectMethods map[string]reflect.Method) (_ []methodDescription, err error) {
...
func (d *apiDocGenerator) extractParams(funcType reflect.Type, methodInfo *pldclient.RPCMethodInfo, isInput bool) ([]param, error) {
	var params []param
	var count int
	discardStart := 0
	discardEnd := 0
...
func (d *apiDocGenerator) generateSimpleTypesMarkdown(ctx context.Context, simpleTypes []interface{}, pageName, outputPath string) []byte {
...
func (d *apiDocGenerator) addPageToMap(t reflect.Type, pageName string) {
...
func (d *apiDocGenerator) generateObjectReferenceMarkdown(ctx context.Context, descRequired bool, example interface{}, t reflect.Type, pageName, outputPath string) ([]byte, error) {
...
func (d *apiDocGenerator) generateFieldDescriptionsForStruct(ctx context.Context, t reflect.Type, pageName string, outputPath string) ([]byte, []byte, error) {
	var err error
...
func (d *apiDocGenerator) writeStructFields(ctx context.Context, t reflect.Type, pageName string, outputPath string, subFieldBuff, tableBuff *bytes.Buffer, tableRowCount int) (int, error) {
