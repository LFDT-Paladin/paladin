...
type SequencingProgressActivity struct {
	LocalID        *uint64            `docstruct:"PublicTx" json:"localId,omitempty"` // only a local DB identifier for the sequencing activity
	CorrelationID  string             `docstruct:"SequencingProgressActivity" json:"correlationId,omitempty"`
	...
	SubmittingNode string             `docstruct:"SequencingProgressActivity" json:"submittingNode,omitempty"`
}
