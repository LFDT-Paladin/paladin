 ...
 *
 * <p>The {@code -32700}..{@code -32600} and {@code -32603} values are the protocol-reserved codes from the
 * JSON-RPC 2.0 specification. The {@code -32000}..{@code -32099} band is reserved by the spec for
 * "implementation-defined server errors"; Paladin uses {@link #UNAUTHORIZED} from that band for
