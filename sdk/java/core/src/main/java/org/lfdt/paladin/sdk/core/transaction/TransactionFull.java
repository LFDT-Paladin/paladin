...
public final class TransactionFull extends Transaction {
  ...
  TransactionFull(
      ...
      @JsonProperty("receipt") final TransactionReceipt receipt,
      @JsonProperty("public") final List<JsonNode> publicTransactions,
      @JsonProperty("history") final List<JsonNode> history,
      @JsonProperty("sequencerActivity") final List<JsonNode> sequencerActivity) {
    super(
        id,
        created,
        submitMode,
