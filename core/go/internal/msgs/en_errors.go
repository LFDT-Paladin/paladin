...
var (
	...
	MsgSequencerAssembleError                      = pde("PD012604", "Error assembling transaction: %s")
	MsgSequencerParseFailed                        = pde("PD012605", "Failed to parse message")
	MsgSequencerInvalidMessage                     = pde("PD012606", "Invalid message received from transport")
	MsgSequencerKeyResolutionFailed                = pde("PD012608", "Key resolution failed for key %s, algorithm %s, verifierType %s")
	MsgSequencerDeployInitFailed                   = pde("PD012609", "Failed to initialise a deploy transaction")
	MsgSequencerDeployPrepareFailed                = pde("PD012610", "Failed to prepare a deploy transaction")
	MsgSequencerDeployPrepareIncomplete            = pde("PD012611", "Prepare step did not return a transaction to invoke, or a transaction to deploy")
	MsgSequencerBaseLedgerTransactionFailed        = pde("PD012612", "Failed to submit base ledger transaction")
	MsgSequencerContractAddressNotProvided         = pde("PD012613", "Contract address (To) not found in the transaction input")
	MsgSequencerPublicTxFail                       = pde("PD012614", "Public transaction rejected")
	MsgSequencerResolveVerifierRemoteFailed        = pde("PD012615", "Failed to resolve verifier on remote node with lookup %s algorithm %s: Error %s")
	MsgSequencerAssembleRevert                     = pde("PD012616", "Domain reverted transaction on assemble: %s")
	MsgSequencerResolveError                       = pde("PD012617", "Failed to resolve local signer for party %s (verifier=%s,algorithm=%s): %s")
	MsgSequencerSignError                          = pde("PD012618", "Failed to sign for party %s (verifier=%s,algorithm=%s): %s")
	MsgSequencerEndorsementRequestError            = pde("PD012619", "Failed to request endorsement from %s: %s")
	MsgSequencerResolveDispatchError               = pde("PD012620", "Failed to resolve dispatcher: %s")
	MsgSequencerPrepareError                       = pde("PD012621", "Failed to prepare transaction dispatch to base ledger: %s")
	MsgSequencerDeployError                        = pde("PD012622", "Failed to deploy private contract")
	MsgSequencerEncodeCallDataFailed               = pde("PD012623", "Failed to encode call data '%s' for private contract deploy")
	MsgSequencerNonLocalSigningAddr                = pde("PD012624", "Attempt do dispatch a blockchain transaction using a signing identity for a different node: %s")
	MsgSequencerReDelegationRequired               = pde("PD012625", "Re-delegation is required for this transaction to progress")
	MsgSequencerDomainMismatch                     = pde("PD012626", "Domain '%s' specified does not match domain '%s' of deployed private smart contract %s")
	MsgSequencerInvalidPrepareOutcome              = pde("PD012627", "Prepare outcome unexpected for transaction %s intent=%s public-submission=%t private-submission=%t")
	MsgSequencerPrepareNotSupportedDeploy          = pde("PD012628", "Preparing transactions for external submission is not supported for deploy")
	MsgSequencerInvalidEventMissingField           = pde("PD012629", "Invalid event: missing field %s")
	MsgSequencerSignRemoteError                    = pde("PD012630", "Attempt to sign a transaction with an identity from a remote node: %s")
	MsgSequencerFromNotResolvedDistroTime          = pde("PD012631", "Failed to extract node from fully qualified from address for state distribution")
	MsgSequencerInvalidTxStateStateDistro          = pde("PD012632", "Invalid transaction state for state distribution")
	MsgSequencerDistributionNotFullyQualified      = pde("PD012633", "State distribution from domain is not fully qualified: %s")
	MsgSequencerInvalidNullifierSpecInDistro       = pde("PD012634", "Invalid nullifier specification in new state instruction from domain")
	MsgSequencerNewSequencerError                  = pde("PD012635", "Failed to create new sequencer")
	MsgSequencerInvalidStaticCoordinator           = pde("PD012636", "Contract was configured with invalid static coordinator '%s'.  Must be of the form 'identity@node'")
	MsgSequencerFunctionNotProvided                = pde("PD012637", "Function abi not provided in transaction input")
	MsgSequencerAssembleRequestInvalid             = pde("PD012638", "Assemble request is invalid for transaction %s")
	MsgSequencerAssembleTxnNotFound                = pde("PD012639", "Transaction %s not found in local node")
	MsgSequencerMaxInflightTransactions            = pde("PD012640", "Max number of inflight transactions (%d) reached. %d transactions delegated from node %s, %d already being coordinated on this node, %d new transactions accepted for coordination, %d rejected")
	MsgSequencerErrorNotifyingDependent            = pde("PD012641", "Error notifying dependent transaction %s of revert of TX %s")
	MsgSequencerErrorRepoolingTX                   = pde("PD012642", "Error repooling TX %s")
	MsgSequencerTransactionNotFound                = pde("PD012643", "TX %s missing from coordinator")
	MsgSequencerInvalidEndorserCandidate           = pde("PD012644", "Invalid coordinator endorser candidate identity '%s'")
	MsgSequencerGrapherAddMinterAlreadyExistsError = pde("PD012645", "Error adding TX %s as minter for state %s, already minted by %s")
