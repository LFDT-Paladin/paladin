...
func action_ResendAssembleSuccessResponse(ctx context.Context, txn *Transaction, _ common.Event) error {
	return action_SendAssembleSuccessResponse(ctx, txn, nil)
}

func action_ResendAssembleRevertResponse(ctx context.Context, txn *Transaction, _ common.Event) error {
	return action_SendAssembleRevertResponse(ctx, txn, nil)
}

func action_ResendAssembleParkResponse(ctx context.Context, txn *Transaction, _ common.Event) error {
