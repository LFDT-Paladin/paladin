...
func (_mock *MockTransportWriter) SendTransactionUnknown(ctx context.Context, coordinatorNode string, txID uuid.UUID, assembleRequestID uuid.UUID) error {
	ret := _mock.Called(ctx, coordinatorNode, txID, assembleRequestID)
	...
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, uuid.UUID, uuid.UUID) error); ok {
		r0 = returnFunc(ctx, coordinatorNode, txID, assembleRequestID)
	} else {
		r0 = ret.Error(0)
	}
	return r0
...
//   - txID uuid.UUID
//   - assembleRequestID uuid.UUID
func (_e *MockTransportWriter_Expecter) SendTransactionUnknown(ctx interface{}, coordinatorNode interface{}, txID interface{}, assembleRequestID interface{}) *MockTransportWriter_SendTransactionUnknown_Call {
	return &MockTransportWriter_SendTransactionUnknown_Call{Call: _e.mock.On("SendTransactionUnknown", ctx, coordinatorNode, txID, assembleRequestID)}
}

func (_c *MockTransportWriter_SendTransactionUnknown_Call) Run(run func(ctx context.Context, coordinatorNode string, txID uuid.UUID, assembleRequestID uuid.UUID)) *MockTransportWriter_SendTransactionUnknown_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockTransportWriter_SendTransactionUnknown_Call) RunAndReturn(run func(ctx context.Context, coordinatorNode string, txID uuid.UUID, assembleRequestID uuid.UUID) error) *MockTransportWriter_SendTransactionUnknown_Call {
	_c.Call.Return(run)
	return _c
}
