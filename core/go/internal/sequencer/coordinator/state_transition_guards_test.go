...
func TestGuard_Behind_BehindByMoreThanTolerance(t *testing.T) {
	ctx := context.Background()
	c, _ := NewCoordinatorBuilderForTesting(t, State_Observing).Build(ctx)
...
func TestGuard_FlushComplete_TransactionsInOtherStates(t *testing.T) {
	ctx := context.Background()
	c, _ := NewCoordinatorBuilderForTesting(t, State_Idle).Build(ctx)
	tx1, _ := transaction.NewTransactionBuilderForTesting(t, transaction.State_Pooled).Build(ctx)
	tx2, _ := transaction.NewTransactionBuilderForTesting(t, transaction.State_Assembling).Build(ctx)
	tx3, _ := transaction.NewTransactionBuilderForTesting(t, transaction.State_Confirmed).Build(ctx)
...
func TestGuard_FlushComplete_TransactionInReadyForDispatchState(t *testing.T) {
	ctx := context.Background()
	c, _ := NewCoordinatorBuilderForTesting(t, State_Idle).Build(ctx)
	tx, _ := transaction.NewTransactionBuilderForTesting(t, transaction.State_Ready_For_Dispatch).
		Build(ctx)
	c.transactionsByID = map[uuid.UUID]*transaction.CoordinatorTransaction{
		tx.GetID(): tx,
	}
...
func TestGuard_FlushComplete_TransactionInDispatchedState(t *testing.T) {
	ctx := context.Background()
	c, _ := NewCoordinatorBuilderForTesting(t, State_Idle).Build(ctx)
	tx, _ := transaction.NewTransactionBuilderForTesting(t, transaction.State_Dispatched).Build(ctx)
	c.transactionsByID = map[uuid.UUID]*transaction.CoordinatorTransaction{
		tx.GetID(): tx,
	}
	result := guard_FlushComplete(ctx, c)
...
func TestGuard_FlushComplete_TransactionInSubmittedState(t *testing.T) {
	ctx := context.Background()
	c, _ := NewCoordinatorBuilderForTesting(t, State_Idle).Build(ctx)
	tx, _ := transaction.NewTransactionBuilderForTesting(t, transaction.State_Submitted).Build(ctx)
	c.transactionsByID = map[uuid.UUID]*transaction.CoordinatorTransaction{
		tx.GetID(): tx,
	}
	result := guard_FlushComplete(ctx, c)
...
func TestGuard_FlushComplete_MultipleTransactionsInFlushStates(t *testing.T) {
	ctx := context.Background()
	c, _ := NewCoordinatorBuilderForTesting(t, State_Idle).Build(ctx)
	tx1, _ := transaction.NewTransactionBuilderForTesting(t, transaction.State_Ready_For_Dispatch).Build(ctx)
	tx2, _ := transaction.NewTransactionBuilderForTesting(t, transaction.State_Dispatched).Build(ctx)
	tx3, _ := transaction.NewTransactionBuilderForTesting(t, transaction.State_Submitted).Build(ctx)
	c.transactionsByID = map[uuid.UUID]*transaction.CoordinatorTransaction{
		tx1.GetID(): tx1,
		tx2.GetID(): tx2,
		tx3.GetID(): tx3,
...
func TestGuard_FlushComplete_MixOfFlushAndNonFlushStates(t *testing.T) {
	...
	c, _ := NewCoordinatorBuilderForTesting(t, State_Idle).Build(ctx)
	tx1, _ := transaction.NewTransactionBuilderForTesting(t, transaction.State_Ready_For_Dispatch).Build(ctx)
	tx2, _ := transaction.NewTransactionBuilderForTesting(t, transaction.State_Confirmed).Build(ctx)
	c.transactionsByID = map[uuid.UUID]*transaction.CoordinatorTransaction{
		tx1.GetID(): tx1,
		tx2.GetID(): tx2,
	}
...
func TestGuard_HasTransactionsInflight_OnlyConfirmedTransactions(t *testing.T) {
	ctx := context.Background()
	c, _ := NewCoordinatorBuilderForTesting(t, State_Idle).Build(ctx)
	tx1, _ := transaction.NewTransactionBuilderForTesting(t, transaction.State_Confirmed).Build(ctx)
	tx2, _ := transaction.NewTransactionBuilderForTesting(t, transaction.State_Confirmed).Build(ctx)
	c.transactionsByID = map[uuid.UUID]*transaction.CoordinatorTransaction{
		tx1.GetID(): tx1,
		tx2.GetID(): tx2,
...
func TestGuard_HasTransactionsInflight_TransactionInPooledState(t *testing.T) {
	ctx := context.Background()
	c, _ := NewCoordinatorBuilderForTesting(t, State_Idle).Build(ctx)
	tx, _ := transaction.NewTransactionBuilderForTesting(t, transaction.State_Pooled).Build(ctx)
	c.transactionsByID = map[uuid.UUID]*transaction.CoordinatorTransaction{
		tx.GetID(): tx,
	}
	result := guard_HasTransactionsInflight(ctx, c)
...
func TestGuard_HasTransactionsInflight_TransactionInAssemblingState(t *testing.T) {
	ctx := context.Background()
	c, _ := NewCoordinatorBuilderForTesting(t, State_Idle).Build(ctx)
	tx, _ := transaction.NewTransactionBuilderForTesting(t, transaction.State_Assembling).Build(ctx)
	c.transactionsByID = map[uuid.UUID]*transaction.CoordinatorTransaction{
		tx.GetID(): tx,
	}
	result := guard_HasTransactionsInflight(ctx, c)
...
func TestGuard_HasTransactionsInflight_TransactionInReadyForDispatchState(t *testing.T) {
	ctx := context.Background()
	c, _ := NewCoordinatorBuilderForTesting(t, State_Idle).Build(ctx)
	tx, _ := transaction.NewTransactionBuilderForTesting(t, transaction.State_Ready_For_Dispatch).Build(ctx)
	c.transactionsByID = map[uuid.UUID]*transaction.CoordinatorTransaction{
		tx.GetID(): tx,
	}
	result := guard_HasTransactionsInflight(ctx, c)
...
func TestGuard_HasTransactionsInflight_MixOfConfirmedAndInflight(t *testing.T) {
	...
	c, _ := NewCoordinatorBuilderForTesting(t, State_Idle).Build(ctx)
	tx1, _ := transaction.NewTransactionBuilderForTesting(t, transaction.State_Confirmed).Build(ctx)
	tx2, _ := transaction.NewTransactionBuilderForTesting(t, transaction.State_Ready_For_Dispatch).Build(ctx)
	c.transactionsByID = map[uuid.UUID]*transaction.CoordinatorTransaction{
		tx1.GetID(): tx1,
		tx2.GetID(): tx2,
	}
...
func TestGuard_ClosingGracePeriodExpired_GracePeriodNotExpired(t *testing.T) {
	ctx := context.Background()
	c, _ := NewCoordinatorBuilderForTesting(t, State_Closing).Build(ctx)
...
func TestGuard_HasTransactionAssembling_MultipleTransactionsInAssemblingState(t *testing.T) {
	ctx := context.Background()
	c, _ := NewCoordinatorBuilderForTesting(t, State_Idle).Build(ctx)
	tx1, _ := transaction.NewTransactionBuilderForTesting(t, transaction.State_Assembling).Build(ctx)
	tx2, _ := transaction.NewTransactionBuilderForTesting(t, transaction.State_Assembling).Build(ctx)
	c.transactionsByID = map[uuid.UUID]*transaction.CoordinatorTransaction{
		tx1.GetID(): tx1,
		tx2.GetID(): tx2,
...
func TestGuard_HasTransactionAssembling_MixOfAssemblingAndOtherStates(t *testing.T) {
	...
	c, _ := NewCoordinatorBuilderForTesting(t, State_Idle).Build(ctx)
	tx1, _ := transaction.NewTransactionBuilderForTesting(t, transaction.State_Assembling).Build(ctx)
	tx2, _ := transaction.NewTransactionBuilderForTesting(t, transaction.State_Pooled).Build(ctx)
	c.transactionsByID = map[uuid.UUID]*transaction.CoordinatorTransaction{
		tx1.GetID(): tx1,
		tx2.GetID(): tx2,
	}
