...
// NewMockChainedChildStore creates a new instance of MockChainedChildStore. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMockChainedChildStore(t interface {
	mock.TestingT
	Cleanup(func())
}) *MockChainedChildStore {
	mock := &MockChainedChildStore{}
	mock.Mock.Test(t)
...
// MockChainedChildStore is an autogenerated mock type for the ChainedChildStore type
type MockChainedChildStore struct {
	mock.Mock
}

type MockChainedChildStore_Expecter struct {
	mock *mock.Mock
}

func (_m *MockChainedChildStore) EXPECT() *MockChainedChildStore_Expecter {
	return &MockChainedChildStore_Expecter{mock: &_m.Mock}
}

// ForgetChainedChild provides a mock function for the type MockChainedChildStore
func (_mock *MockChainedChildStore) ForgetChainedChild(parentID uuid.UUID) {
	_mock.Called(parentID)
	return
}

// MockChainedChildStore_ForgetChainedChild_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ForgetChainedChild'
type MockChainedChildStore_ForgetChainedChild_Call struct {
	*mock.Call
}

// ForgetChainedChild is a helper method to define mock.On call
//   - parentID uuid.UUID
func (_e *MockChainedChildStore_Expecter) ForgetChainedChild(parentID interface{}) *MockChainedChildStore_ForgetChainedChild_Call {
	return &MockChainedChildStore_ForgetChainedChild_Call{Call: _e.mock.On("ForgetChainedChild", parentID)}
}

func (_c *MockChainedChildStore_ForgetChainedChild_Call) Run(run func(parentID uuid.UUID)) *MockChainedChildStore_ForgetChainedChild_Call {
...
func (_c *MockChainedChildStore_ForgetChainedChild_Call) Return() *MockChainedChildStore_ForgetChainedChild_Call {
	_c.Call.Return()
	return _c
}

func (_c *MockChainedChildStore_ForgetChainedChild_Call) RunAndReturn(run func(parentID uuid.UUID)) *MockChainedChildStore_ForgetChainedChild_Call {
	_c.Run(run)
	return _c
}

// GetChainedChild provides a mock function for the type MockChainedChildStore
func (_mock *MockChainedChildStore) GetChainedChild(parentID uuid.UUID) *uuid.UUID {
	ret := _mock.Called(parentID)

	if len(ret) == 0 {
		panic("no return value specified for GetChainedChild")
	}
...
// MockChainedChildStore_GetChainedChild_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetChainedChild'
type MockChainedChildStore_GetChainedChild_Call struct {
	*mock.Call
}

// GetChainedChild is a helper method to define mock.On call
//   - parentID uuid.UUID
func (_e *MockChainedChildStore_Expecter) GetChainedChild(parentID interface{}) *MockChainedChildStore_GetChainedChild_Call {
	return &MockChainedChildStore_GetChainedChild_Call{Call: _e.mock.On("GetChainedChild", parentID)}
}

func (_c *MockChainedChildStore_GetChainedChild_Call) Run(run func(parentID uuid.UUID)) *MockChainedChildStore_GetChainedChild_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 uuid.UUID
		if args[0] != nil {
			arg0 = args[0].(uuid.UUID)
...
func (_c *MockChainedChildStore_GetChainedChild_Call) Return(uUID *uuid.UUID) *MockChainedChildStore_GetChainedChild_Call {
	_c.Call.Return(uUID)
	return _c
}

func (_c *MockChainedChildStore_GetChainedChild_Call) RunAndReturn(run func(parentID uuid.UUID) *uuid.UUID) *MockChainedChildStore_GetChainedChild_Call {
	_c.Call.Return(run)
	return _c
}

// SetChainedChild provides a mock function for the type MockChainedChildStore
func (_mock *MockChainedChildStore) SetChainedChild(parentID uuid.UUID, childID uuid.UUID) {
	_mock.Called(parentID, childID)
	return
}

// MockChainedChildStore_SetChainedChild_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SetChainedChild'
type MockChainedChildStore_SetChainedChild_Call struct {
	*mock.Call
}

// SetChainedChild is a helper method to define mock.On call
//   - parentID uuid.UUID
//   - childID uuid.UUID
func (_e *MockChainedChildStore_Expecter) SetChainedChild(parentID interface{}, childID interface{}) *MockChainedChildStore_SetChainedChild_Call {
	return &MockChainedChildStore_SetChainedChild_Call{Call: _e.mock.On("SetChainedChild", parentID, childID)}
}

func (_c *MockChainedChildStore_SetChainedChild_Call) Run(run func(parentID uuid.UUID, childID uuid.UUID)) *MockChainedChildStore_SetChainedChild_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 uuid.UUID
		if args[0] != nil {
			arg0 = args[0].(uuid.UUID)
...
func (_c *MockChainedChildStore_SetChainedChild_Call) Return() *MockChainedChildStore_SetChainedChild_Call {
	_c.Call.Return()
	return _c
}

func (_c *MockChainedChildStore_SetChainedChild_Call) RunAndReturn(run func(parentID uuid.UUID, childID uuid.UUID)) *MockChainedChildStore_SetChainedChild_Call {
	_c.Run(run)
	return _c
}
...
func (_mock *MockCoordinatorTransaction) DependentsMustWait(ctx context.Context) bool {
...
//   - ctx context.Context
func (_e *MockCoordinatorTransaction_Expecter) DependentsMustWait(ctx interface{}) *MockCoordinatorTransaction_DependentsMustWait_Call {
	return &MockCoordinatorTransaction_DependentsMustWait_Call{Call: _e.mock.On("DependentsMustWait", ctx)}
}

func (_c *MockCoordinatorTransaction_DependentsMustWait_Call) Run(run func(ctx context.Context)) *MockCoordinatorTransaction_DependentsMustWait_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockCoordinatorTransaction_DependentsMustWait_Call) RunAndReturn(run func(ctx context.Context) bool) *MockCoordinatorTransaction_DependentsMustWait_Call {
	_c.Call.Return(run)
	return _c
}
